...
class FakeTmdbApi : TmdbApi {
    ...
    override suspend fun movieDetails(
        ...
        return jsonAdapterMovie.fromJson(jsonresult) ?: TmdbMovie()
    }
    ...
    override suspend fun serieDetails(
        ...
        return jsonAdapterSerie.fromJson(jsonresult) ?: TmdbSerie()
    }
}